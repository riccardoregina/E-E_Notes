...
Il seguente teorema ci permette di usare il metodo di Sardinas-Patterson per determinare se un codice abbia ritardo di decodifica finito e la sua dimostrazione ci dice inoltre il valore effettivo di tale ritardo. D'altra parte, la dimostrazione fornisce anche un limite superiore di passi del metodo di Sardinas-Patterson per verificare se un codice abbia un certo ritardo di decodifica.

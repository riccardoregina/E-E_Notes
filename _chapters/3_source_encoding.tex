...
Il teorema di Shannon (\Cref{thm:shannon}) fornisce un limite inferiore per il costo di codifica. Il seguente teorema, fornisce anche un limite superiore.
\begin{theorem}{}
...
\begin{observation}{}
  ...
  Per i codici prefisso invece sì, poiché, per un codice prefisso, essere massimale è equivalente all'esistenza di un albero completo.

...
Pertanto, l'insieme delle parti dei codici su $A$ è infinito non numerabile.
...
Se però questo pattern si interrompe, ricevendo ad un certo punto \(\ldots baab \ldots\), allora siamo sicuri che queste due parole sono \(ba\) e \(ab\), e quindi possiamo risincronizzare la nostra decodifica, avendo adesso un punto dicronizzare la nostra decodifica, avendo adesso un punto di \qi{inizio}.
